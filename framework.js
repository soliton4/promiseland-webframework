...
var PL$16/*self*/;
var PL$28/*d*/;
var PL$29/*ClientProfile*/;
var PL$34/*clientProfile*/;
var PL$35/*mainio*/;
;
...
PL$21/*i*/;
for(PL$21/*i*/ = 0;(PL$21/*i*/ < PL$16/*self*/["config"]["css"]["length"]);++PL$21/*i*/){{PL$20/*cssStr*/ += (("<link type = \"text/css\" rel=\"stylesheet\" href=\"" + PL$16/*self*/["config"]["css"][PL$21/*i*/]) + "\">");;
}};
;
};
;
...
PL$23/*requireConfig*/["packages"] = [{"name": "promiseland",
"main": "promiseland",
...
PL$21/*i*/ = 0;
PL$24/*found*/ = false;
for(PL$21/*i*/ = 0;(PL$21/*i*/ < PL$23/*requireConfig*/["packages"]["length"]);++PL$21/*i*/){{if((PL$23/*requireConfig*/["packages"][PL$21/*i*/]["name"] == "promiseland")){
PL$24/*found*/ = true;;
...
;
if(! PL$24/*found*/){
PL$23/*requireConfig*/["packages"]["push"]({"name": "promiseland",
"main": "promiseland",
"location": "promiseland"});;
};
;
...
for(PL$21/*i*/ = 0;(PL$21/*i*/ < PL$16/*self*/["config"]["dirs"]["length"]);++PL$21/*i*/){{PL$28/*d*/ = PL$16/*self*/["config"]["dirs"][PL$21/*i*/];
...
PL$34/*clientProfile*/ = new PL$29/*ClientProfile*/();
PL$26/*promiseland*/["addProfile"](PL$34/*clientProfile*/);;
this["clientProfile"] = PL$34/*clientProfile*/;;
PL$35/*mainio*/ = PL$11/*socketIo*/["listen"](this["http"]);
PL$35/*mainio*/["on"]("connection", (function(PL$36/*socket*/){
var PL$32/*connection*/;
;
PL$32/*connection*/ = new PL$26/*promiseland*/["ConnectionBaseClass"]();
